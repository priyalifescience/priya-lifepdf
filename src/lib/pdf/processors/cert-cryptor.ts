...
export class CertCryptorProcessor extends BasePDFProcessor {
  async process(
    ...
    try {
      ...
      // Draw Central Stamp Symbol (e.g. Shield + Key / Priya LifePDF Logo)
      ...
      const signatureDict = context.obj({
        ...
        Reason: pdfLib.PDFString.of('Signed officially using Priya LifePDF Wax-Seal cryptor.'),
      ...
      if (certFile || cryptorOptions.encryptWithCert) {
        ...
        const userPassword = cryptorOptions.pfxPassword || 'priya-lifepdf';
