...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} Priya LifePDF. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "Priya LifePDF" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays Priya LifePDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('Priya LifePDF');
    ...
    it('Footer component displays Priya LifePDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('Priya LifePDF');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('priya-lifepdf-language-preference', invalidLocale);
