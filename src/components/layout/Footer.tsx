  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/priyalifescience/priya-lifepdf" className="p-2 rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-primary))] hover:text-white transition-all">
                <Github className="w-4 h-4" />
              </a>
              <a href="https://x.com/priyalifescience" className="p-2 rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-primary))] hover:text-white transition-all">
        ...
        {/* GDPR & Priya Life Science Footer Text */}
        <div className="pt-8 border-t border-[hsl(var(--color-border))] text-sm text-[hsl(var(--color-muted-foreground))] space-y-4">
          <p>
            Priya LifePDF is a free, open-source tool operated by{' '}
            <a href="https://priyalifescience.com" className="text-[hsl(var(--color-primary))] hover:underline font-semibold">Priya Life Science</a>, Ireland.
            Source code:{' '}
            <a href="https://github.com/priyalifescience/priya-lifepdf" className="text-[hsl(var(--color-primary))] hover:underline font-semibold">
              GitHub
            </a>. Licensed under AGPL-3.0.
          </p>
          <p>
            No files are transmitted, stored, or processed on any server. All operations run locally in your browser using
            WebAssembly and JavaScript. This tool complies with GDPR Article 25 (Privacy by Design) and the Irish Data
            Protection Act 2018.
          </p>
          <p>
            For life science career tools, jobs, and training:{' '}
            <a href="https://priyalifescience.com" className="text-[hsl(var(--color-primary))] hover:underline font-semibold">
              priyalifescience.com
            </a>
          </p>
        </div>

        {/* Copyright */}
        <div className="pt-8 border-t border-[hsl(var(--color-border))] flex flex-col md:flex-row items-center justify-between gap-4 mt-6">
          <p className="text-sm text-[hsl(var(--color-muted-foreground))]">
            &copy; {currentYear} Priya LifePDF. All rights reserved.
          </p>
    ...
    {/* Back-link banner */}
    <div style={{ background: '#151B1F', color: '#fff', textAlign: 'center', padding: '10px', fontSize: '13px' }}>
      Looking for pharma jobs in Ireland?{' '}
      <a href="https://priyalifescience.com/life-science-careers-ireland" 
         style={{ color: '#66B539', fontWeight: 700 }}>
        Visit Ireland's Life Science Career Hub →
      </a>
    </div>
  </>
);
