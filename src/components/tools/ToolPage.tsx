    ...
    <ToolProvider toolSlug={tool.slug} toolName={toolDisplayName}>
      <div className="min-h-screen flex flex-col" data-testid="tool-page">
        ...
        <main id="main-content" className="flex-1 pt-[72px]" tabIndex={-1}>
          ...
          <div className="w-full bg-emerald-600 border-b border-emerald-700 py-2 overflow-hidden select-none z-40 relative flex">
            <div className="flex whitespace-nowrap animate-[marquee_35s_linear_infinite] gap-12 text-xs sm:text-sm font-semibold text-white tracking-wider uppercase">
              <div className="flex gap-12 items-center">
                <span>🛡️ 100% Client-Side Processing</span>
                <span>•</span>
                <span>Files Never Leave Your Device</span>
                <span>•</span>
                <span>Compliant with GDPR Article 25 (Privacy by Design)</span>
                <span>•</span>
                <span>Governed under Irish Data Protection Act 2018</span>
                <span>•</span>
                <span>Managed by Priya Life Science Ireland</span>
                <span>•</span>
                <span>GxP Pharma Compliant Architecture</span>
              </div>
