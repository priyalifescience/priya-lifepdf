      ...
      >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 min-w-0">
            <h3
              className="text-base font-bold text-[hsl(var(--color-card-foreground))] line-clamp-2 mb-2 group-hover:text-[hsl(var(--color-primary))] transition-colors leading-snug"
