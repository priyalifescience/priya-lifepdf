...
export function BatchBarcodeInjectorTool({ className = '' }: BatchBarcodeInjectorToolProps) {
  ...
  const [value, setValue] = useState('https://priya-lifepdf.org');
      ...
      {file && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Card variant="default" className="p-6 bg-white/40 dark:bg-black/30 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800 rounded-[2rem] shadow-xl flex flex-col justify-between min-h-[380px]">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="e.g. https://priya-lifepdf.org"
