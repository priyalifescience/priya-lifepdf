...
const STATIC_PAGES = [
  ...
  { path: '/gmp-stamp-guide', priority: 0.92, changeFrequency: CHANGE_FREQUENCY.tools },
...
function generateLocaleEntries(locale: Locale, lastModified: Date): MetadataRoute.Sitemap {
  ...
  // Add tool pages (gmp-stamp gets flagship priority)
  ...
  for (const tool of tools) {
    entries.push({
      ...
      priority: tool.slug === 'gmp-stamp' ? 0.95 : PRIORITY.toolPage,
    });
  }
