...
const builderPath = 'd:\\NextProject\\priya-pdf-editor\\scratch\\i18n-builder-extended.cjs';
...
fs.writeFileSync('d:\\NextProject\\priya-pdf-editor\\scratch\\mapping.json', JSON.stringify(stringMap, null, 2), 'utf8');
